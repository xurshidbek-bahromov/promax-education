...
const MainButton = forwardRef<HTMLButtonElement, MainButtonProps>(
  (
    ...
    const propWidth =
      width === "full_width" ? "w-full" : width ? width : "w-[120px]";
    ...
    return !isLoading ? (
      <Button
        ...
        } text-white shadow-xl ${propWidth} md:${propWidth}  select-none rounded-full hover:opacity-90 ${variant_hover} ${size_height} ${classes}`}
